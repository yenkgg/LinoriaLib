...
do
    ...
    function BaseGroupboxFuncs:AddSlider(Idx, Info)
        ...
        -- Smooth animated slider thumb
        local SliderThumb = Library:Create("Frame", {
            AnchorPoint = Vector2.new(0.5, 0.5);
        ...
        Library:AddToRegistry(SliderThumb, {
            BackgroundColor3 = "FontColor";
            BorderColor3 = "AccentColorDark";
        })

        local SliderThumbTween
        local function AnimateSliderThumb(X)
            if SliderThumbTween then
                SliderThumbTween:Cancel()
            end

            SliderThumbTween = TweenService:Create(
                SliderThumb,
                TweenInfo.new(0.09, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                { Position = UDim2.new(X, 0, 0.5, 0) }
            )
            SliderThumbTween:Play()
        end
        ...
        function Slider:UpdateColors()
            ...
            SliderThumb.BackgroundColor3 = Slider.Disabled and Library.DisabledAccentColor or Library.FontColor
            SliderThumb.BorderColor3 = Slider.Disabled and Library.DisabledOutlineColor or Library.AccentColorDark
            Library.RegistryMap[SliderThumb].Properties.BackgroundColor3 = Slider.Disabled and "DisabledAccentColor" or "FontColor"
            Library.RegistryMap[SliderThumb].Properties.BorderColor3 = Slider.Disabled and "DisabledOutlineColor" or "AccentColorDark"
        end
    ...
    function BaseGroupboxFuncs:AddDropdown(Idx, Info)
        ...
        function Dropdown:OpenDropdown()
            ...
            local AnimationId = DropdownAnimationId
            ...
            ListOuter.Size = UDim2.fromOffset(TargetSize.X.Offset, 0)
            ListInner.BackgroundTransparency = 1
            Scrolling.CanvasPosition = Vector2.zero

            DropdownArrow.Rotation = 0

            DropdownTween = TweenService:Create(
                ListOuter,
        ...
        function Dropdown:CloseDropdown()
            ...
            local CurrentSize = ListOuter.Size
            Library.OpenedFrames[ListOuter] = nil
            ...
            task.delay(0.14, function()
                if AnimationId ~= DropdownAnimationId then
                    return
                end
...
do
    ...
    function Library:SetKeybindListVisible(Visible)
        Visible = if typeof(Visible) == "boolean" then Visible else not KeybindOuter.Visible

        if Visible then
            KeybindOuter.Visible = true
            KeybindOuter.Position = KeybindOuter.Position + UDim2.fromOffset(10, 0)
            TweenService:Create(
                KeybindOuter,
                TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                { Position = KeybindOuter.Position - UDim2.fromOffset(10, 0) }
            ):Play()
        else
            TweenService:Create(
                KeybindOuter,
...
do
        ...
        function Tab:ShowTab()
            ...
            TabFrame.Position = UDim2.new(0, 8, 0, 0)
            ...
            -- Subtle tab button feedback
            TweenService:Create(
                TabButton,
                TweenInfo.new(0.14, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                { Size = UDim2.new(0, TabButtonWidth + 10, 0.88, 0) }
            ):Play()
